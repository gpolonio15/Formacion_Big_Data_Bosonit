...
# MAGIC %md
# MAGIC ## Leemos la US Flights table
...
# MAGIC %md
# MAGIC Comprobamos que se ha producido el CACHE.
...
# MAGIC %md
# MAGIC ### Mostrar las columnas de la table
